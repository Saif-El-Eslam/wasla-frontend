...
import { BarChart3, Building2, LayoutDashboard, Package } from 'lucide-react';
import { useTranslations } from 'next-intl';
import { cx } from '@/components/ui/dashboard-ui';

export type AdminSubscriptionTab = 'home' | 'venues' | 'matrix' | 'plans';
...
export function AdminSubscriptionTabs({
  ...
  return (
    <div className="grid gap-2 rounded-3xl border border-teal-100 bg-white/90 p-1.5 shadow-glass sm:grid-cols-2 xl:grid-cols-4">
      {tabs.map((tab) => {
        const Icon = tab.icon;
