...
const copy = {
  ...
  ar: {
    prompt: 'Ù‚ÙŠÙ‘Ù… ØªØ¬Ø±Ø¨ØªÙƒ',
    title: 'ÙƒØ§Ù†Øª ØªØ¬Ø±Ø¨ØªÙƒ Ø¹Ø§Ù…Ù„Ø© Ø¥Ø²Ø§ÙŠØŸ',
    body: 'ØªÙ‚ÙŠÙŠÙ… Ø³Ø±ÙŠØ¹ ÙŠØ³Ø§Ø¹Ø¯ Ø§Ù„ÙØ±Ø¹ ÙŠØªØ­Ø³Ù† Ù…Ù† ØºÙŠØ± Ù…Ø§ ÙŠØ¹Ø·Ù„Ùƒ Ø¹Ù† ØªØµÙØ­ Ø§Ù„Ù…Ù†ÙŠÙˆ.',
    comment: 'Ø§ÙƒØªØ¨ Ù„Ù†Ø§ Ø§Ù„Ù„ÙŠ Ø­ØµÙ„ (Ø§Ø®ØªÙŠØ§Ø±ÙŠ)',
    submit: 'Ø¥Ø±Ø³Ø§Ù„ Ø§Ù„ØªÙ‚ÙŠÙŠÙ…',
    thanksPrivate: 'Ø´ÙƒØ±Ø§Ù‹ Ù„Ùƒ. ØµØ§Ø­Ø¨ Ø§Ù„ÙØ±Ø¹ Ø³ÙŠÙ‚Ø±Ø£ Ø§Ù„Ù…Ù„Ø§Ø­Ø¸Ø© Ø¨Ø´ÙƒÙ„ Ø®Ø§Øµ.',
    thanksPublic: 'Ø´ÙƒØ±Ø§Ù‹ Ø¹Ù„Ù‰ ØªÙ‚ÙŠÙŠÙ…Ùƒ Ø§Ù„Ø¬Ù…ÙŠÙ„.',
    googleCta: 'Ø§Ù„Ù…ØªØ§Ø¨Ø¹Ø© Ù„ØªÙ‚ÙŠÙŠÙ… Ø¬ÙˆØ¬Ù„',
    googleHint: 'ØªÙ‚ÙŠÙŠÙ…Ùƒ Ø§Ù„Ø¹Ø§Ù… ÙŠØ³Ø§Ø¹Ø¯ Ø¶ÙŠÙˆÙ Ø£ÙƒØ«Ø± ÙŠÙƒØªØ´ÙÙˆØ§ Ø§Ù„ÙØ±Ø¹.',
    close: 'Ø¥ØºÙ„Ø§Ù‚',
    saved: 'ØªÙ… Ø§Ù„Ø­ÙØ¸',
  },
} as const;
