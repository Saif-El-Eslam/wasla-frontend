...
import { CreditCard, LifeBuoy, LockKeyhole, Store, UserRound, Users } from 'lucide-react';
...
export function SettingsTabs({
  ...
  return (
    <div className="grid gap-2 rounded-3xl border border-teal-100 bg-white/90 p-1.5 shadow-glass sm:grid-cols-2 lg:grid-cols-6">
