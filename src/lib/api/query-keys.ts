export const queryKeys = {
  ...
  feedbackDashboard: (filters?: Record<string, unknown>) => ['feedback', 'dashboard', filters ?? {}] as const,
  financeAccess: ['finance', 'access'] as const,
  financeDashboard: (filters?: Record<string, unknown>) => ['finance', 'dashboard', filters ?? {}] as const,
  financialTransactions: (filters?: Record<string, unknown>) =>
    ['finance', 'transactions', filters ?? {}] as const,
  financialCategories: (filters?: Record<string, unknown>) =>
    ['finance', 'categories', filters ?? {}] as const,
  financialPaymentMethods: (filters?: Record<string, unknown>) =>
